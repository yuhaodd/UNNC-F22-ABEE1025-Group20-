...
class MatrixCalculator:
    ...
    def show_userguide(self):
        ...
        self.content.insert(18.0,
            '    4) The inputs of Matrix A and Matrxi B should be \n')
        self.content.insert(19.0,
            '        the same dimension for addition and subtraction.\n')
        self.content.insert(20.0,
            '    5) The column number of Matrix A should be the same \n')
        self.content.insert(21.0,
            '        as the row number of Matrix B for multiplication.\n')
        self.content.insert(22.0,
            'NOTICE 2\n')
        self.content.insert(23.0,
            '    For Matrix Operation:\n')
        self.content.insert(24.0,
            '    1) The inputs of matrix must be confirmed \n')
        self.content.insert(25.0,
            '        by Button "Confirm" before any operation.\n')
        self.content.insert(26.0,
            '    2) For "Transpose", \n')
        self.content.insert(27.0,
            '        input one matrix (A or B) is enough.\n')
        self.content.insert(28.0,
            '        For "Add", "Subtract" and "Multiply", \n')
        self.content.insert(29.0,
            '        input both matrix A and martrix B.\n')
        self.content.insert(30.0,
            '    3) The three different clear buttons are  \n')
        self.content.insert(31.0,
            '        responsible for deleting the corresponding parts.\n')
